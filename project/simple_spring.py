...
class Simple_spring(graph_class.Graph_random):
    def __init__(self, nr_vertices, edge_prob, c_1, c_2, c_3, c_4):
        ...
        self.c_3 = c_3
        self.c_4 = c_4
        self.forces_repel = np.zeros((self.nr_vertices, self.nr_vertices))
        self.forces_repel_vec = np.zeros((self.nr_vertices, self.nr_vertices, 2))
    ...
    def calc_repel_force(self):
        ...
        for j in range(0, self.nr_vertices):
            ...
            for i in range(0, self.nr_vertices):
                if i not in self.rdn_graph[j] and i !=j:
    ...
    def calc_attract_force(self):
        ...
        self.forces_attract[:][:]=0
        self.forces_attract_vec[:][:][:]=0
        for i in range(0, self.nr_vertices):
